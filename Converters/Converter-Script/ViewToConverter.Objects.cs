...
namespace ViewObjects.Converter.Script
{
	public partial class ViewObjectConverter
	{
		...
		private IViewObj CheckIfWrapper(Base @base)
		{
			var res = @base["@data"];
			// The speckle sender component wraps all the data into a parent Base object. This will check if a Bae object is a wrapper
			return RecursiveToNative(res);
		}
